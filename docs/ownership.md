...
| conversion | HTML, Kramdown, dialect helpers, structured data core | Declare the source/target subset and lossiness; reuse structured_to_markdown / markdown_to_structured for JSON-compatible adapter data. |
